    Shader "Draw Sphere Smooth"
    {
        ...
        {  
            Pass
            {
                ...
                float4 VSMain (uint id:SV_VertexID, out float3 p:TEXCOORD0, out float3 n:TEXCOORD1) : SV_POSITION
                {
                    float f = id;
                ...
                float4 PSMain (float4 s:SV_POSITION, float3 p:TEXCOORD0, float3 n:TEXCOORD1) : SV_Target
                {  
